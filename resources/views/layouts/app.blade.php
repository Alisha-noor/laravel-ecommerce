...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Jost:wght@200;300;400;500;600;700;800;900&family=Allura&family=Inter:wght@400;500;600;700;800;900&family=Playfair+Display:ital,wght@0,900;1,900&family=Source+Sans+Pro:wght@400;600;700;900&display=swap"
        rel="stylesheet">
...
<style>
    ...
    * {
    ...
    .count2 {
        ...
        padding: 100px;
        color: rgb(27, 23, 23);
        /* Text color clear karne ke liye */
        text-align: center;
        overflow: hidden;
        /* Extra blur ko hatane ke liye */
    }
    ...
    .count2::before {
        ...
        width: 100%;
        height: 100vh;
        background-image: url("https://t3.ftcdn.net/jpg/04/83/00/94/360_F_483009486_wU5edTRo4gR6Cedu0j6qPhjS0cbRjhyl.jpg");
...
<body>
    ...
    <div class="text-center" style="background-color:#b56576;  color:white; font-family: 'Playfair Display', serif;">
        <p class="text-reset fw-bold moving-text">
            Upgrade Your Style with Bagverse – Flat 50% Off on Luxury Bags for a Limited Time!
        </p>
    </div>
    <header class="bg-white shadow sticky top-0 z-50 " style="font-family: 'Playfair Display', serif;">
        <div class="container mx-auto flex flex-wrap md:flex-nowrap items-center justify-between px-4 py-3">

            <!-- Logo / Brand Name -->
            <!-- Logo / Brand Name -->
            <a href="{{ route('home.index') }}" class="flex items-center mr-6">
                <img src="https://static.vecteezy.com/system/resources/previews/008/822/957/non_2x/shopping-bag-icon-in-pink-color-vector.jpg"
                    alt="Bagverse Logo" class="h-10 w-auto md:h-12 rounded-lg shadow-sm">
                <span class="ml-2 text-2xl font-bold text-[#b56576]"
                    style="font-family: 'Playfair Display', serif;">Bagverse</span>
            ...
            <div class="flex-1 hidden md:flex md:items-center md:justify-between md:space-x-6" id="desktop-menu">


                <!-- Nav Links -->
                <nav class="flex flex-col md:flex-row md:space-x-6 space-y-2 md:space-y-0 text-gray-700">
                    <a href="{{ route('home.index') }}" class="hover:text-[#b56576] font-medium transition">Home</a>
                    <a href="{{ route('shop.index') }}" class="hover:text-[#b56576] font-medium transition">Shop</a>
                    <a href="{{ route('cart.index') }}" class="hover:text-[#b56576] font-medium transition">Cart</a>
                    <a href="{{ route('about.index') }}" class="hover:text-[#b56576] font-medium transition">About</a>
                    <a href="{{ route('home.index') }}#contact"
                        class="hover:text-[#b56576] font-medium transition">Contact</a>
                </nav>
    ...
    <div class="position-relative">
        ...
        <button class="btn-icon search-popup__submit" type="submit">
            <svg width="20" height="20">
                <use href="#icon_search" />
                        ...
                        <!-- Wishlist -->
                        <a href="{{ route('wishlist.index') }}" class="relative p-2 hover:text-[#b56576] transition">
                            <svg width="20" height="20" fill="none">
                                <use href="#icon_heart" />
                            </svg>
                            @if (Cart::instance('wishlist')->content()->count() > 0)
                                <span
                                    class="absolute -top-1 -right-1 bg-[#b56576] text-white text-xs w-4 h-4 flex items-center justify-center rounded-full">
                        ...
                        <!-- Cart -->
                        <!-- Cart -->
                        <a href="{{ route('cart.index') }}" class="relative p-2 hover:text-[#b56576] transition">
                            <svg width="20" height="20" fill="none">
                                <use href="#icon_cart" />
                            </svg>

                            @php($cartQty = Cart::instance('cart')->count()) {{-- total quantity in cart --}}
                            @if ($cartQty > 0)
                                <span
                                    class="absolute -top-1 -right-1 bg-[#b56576] text-white text-xs w-4 h-4 flex items-center justify-center rounded-full">
                                    {{ $cartQty }}
        ...
        <!-- Mobile Menu -->
        <div class="md:hidden hidden bg-white border-t shadow-md" id="mobile-menu">
            <nav class="flex flex-col p-4 space-y-2 text-gray-700">
                <a href="{{ route('home.index') }}" class="hover:text-[#b56576] font-medium transition">Home</a>
                <a href="{{ route('shop.index') }}" class="hover:text-[#b56576] font-medium transition">Shop</a>
                <a href="{{ route('cart.index') }}" class="hover:text-[#b56576] font-medium transition">Cart</a>
                <a href="{{ route('about.index') }}">About</a>
                <a href="#contact" class="hover:text-[#b56576] font-medium transition">Contact</a>

                <!-- Mobile Search Popup -->
                <div class="mt-4">
                    <form action="" method="GET" class="search-field position-relative">
                        <div class="position-relative">
                            <input class="search-field__input w-100 border rounded-1" type="text" name="keyword"
                            ...
                            <button class="btn-icon btn-close-lg search-popup__reset pb-0 me-2"
                                type="reset"></button>
                        </div>
                    </form>
                </div>
                ...
                <div class="flex space-x-4 mt-4">
                    <a href="{{ route('wishlist.index') }}" class="p-2 hover:text-[#b56576] transition">
                        <svg width="20" height="20" fill="none">
                            <use href="#icon_heart" />
                        </svg>
                    </a>
                    <a href="{{ route('cart.index') }}" class="p-2 hover:text-[#b56576] transition">
                        <svg width="20" height="20" fill="none">
                            <use href="#icon_cart" />
                        </svg>
                    </a>
                ...
                @guest
                    <div class="flex flex-col mt-4 space-y-2">
                        <a href="{{ route('login') }}"
                            class="px-3 py-1 border border-[#b56576] rounded-full text-sm font-medium text-[#b56576] hover:bg-[#b56576] hover:text-white transition text-center">
                            Login
                        </a>
                        <a href="{{ route('register') }}"
                            class="px-3 py-1 border border-[#b56576] rounded-full text-sm font-medium text-[#b56576] hover:bg-[#b56576] hover:text-white transition text-center">
    ...
    <div id="chat-popup"
        style="position: fixed; bottom: 30px; right: 70px; width: 300px; 
    ...
    <button onclick="openChat()"
        style="position:fixed; bottom:20px; right:20px; background:#b56576; 
    ...
    <!-- Popup Message -->
    {{-- <div id="autoMessage" class="popup-message mt-5">
        <a href="https://wa.me/923162299686" class="whatsapp-button"><i class="fa-brands fa-whatsapp"
                style="color: #14ad73;font-size: 50px;"></i></a>
        <button onclick="closePopup()" style="color: black;">×</button>
    </div> --}}
    <div id="chat-popup"
        style="position: fixed; bottom: 30px; right: 70px; width: 300px; 
    ...
    <footer class="text-center text-lg-start mt-3" style="background-color: #b56576; color: white;"data-aos="fade-up"
        data-aos-duration="1200">
        <section
            class="d-flex flex-wrap justify-content-center justify-content-lg-between p-4 border-bottom border-dark">
            <div class="me-5 d-none d-lg-block">
                <i class="fas fa-gem me-3"></i> <span>Get connected with us on social networks:</span>
            </div>
            <div class="d-flex gap-3">
                <a href="#" class="text-reset footer-icon">
        ...
        <section class="container text-center text-md-start mt-5">
            <div class="row mt-3">
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 text-sm-start">
                    <h6 class="text-uppercase fw-bold fs-6 mb-4 d-flex align-items-center">
                        <img src="https://static.vecteezy.com/system/resources/previews/008/822/957/non_2x/shopping-bag-icon-in-pink-color-vector.jpg"
                            style="width: 50px; border-radius: 50px;" class="logohover me-2" alt="Logo">
                        <span class="text-2xl font-bold text-white"
                            style="font-family: 'Playfair Display', serif;">Bagverse</span>
                    </h6>

                    <p>
                        "At Bagverse, we create bags that balance **style, comfort, and durability**.
                        From elegant handbags to rugged travel essentials, our collection is designed
                        for those who carry more than just belongings — they carry their world.
                        Step into Bagverse, where every bag tells a story of fashion and function."
                    </p>
                </div>

                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4 text-sm-start">
                    <h6 class="text-uppercase fw-bold fs-6 mb-4 text-white">Products</h6>
                    <p><a href="#handbags" class="footer-link  text-white ">Handbags</a></p>
                    <p><a href="#backpacks" class="footer-link text-white ">Backpacks</a></p>
                    <p><a href="#travel" class="footer-link    text-white ">Travel Bags</a></p>
                    <p><a href="#wallets" class="footer-link   text-white ">Wallets</a></p>
                </div>

                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4 text-sm-start ">
                    <h6 class="text-uppercase fw-bold fs-6 mb-4 text-white ">Useful Links</h6>
                    <p><a href="#!" class="footer-link          text-white ">New Arrivals</a></p>
                    <p><a href="#!" class="footer-link          text-white  ">Best Sellers</a></p>
                    <p><a href="#!" class="footer-link          text-white ">Orders</a></p>
                    <p><a href="#!" class="footer-link          text-white ">Customer Care</a></p>
                </div>

                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 text-sm-start">
                    <h6 class="text-uppercase fw-bold fs-6 mb-4   text-white ">Contact</h6>
                    <p><i class="fas fa-home me-3"></i>Atrium Mall, Karachi</p>
                    <a style="color: rgb(248, 243, 243); text-decoration: none;"
                        href="mailto:bagverse@gmail.com?subject=Product Inquiry&body=I want to know more about your bags.">
                        <p><i class="fas fa-envelope me-3"></i> bagverse@gmail.com</p>
                    </a>
                    <a href="https://wa.me/923162299686" style="text-decoration: none; color: rgb(244, 243, 243);">
                        <p><i class="fas fa-phone me-3"></i> +92-3162299686</p>
                        <p><i class="fas fa-print me-3"></i> +92-3162352255</p>
                    </a>
                </div>
            </div>
        </section>
        ...
        <div class="text-center p-3 border-top border-dark">
            © 2025 Bagverse. All Rights Reserved.
        </div>
    </footer>
    ...
    <script>
        ...
        function downloadDescription(brand, text) {
            const blob = new Blob([text], {
                type: "text/plain"
            });
            const link = document.createElement("a");
            link.href = URL.createObjectURL(blob);
            link.download = `${brand}_Description.txt`;
            link.click();
        }
        ...
        function showSlide(i) {
            ...
            dots.forEach((d, idx) => d.classList.toggle("bg-[#b56576]", idx === i));
        }
