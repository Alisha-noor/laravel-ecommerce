...
@section('content')
    <style>
        ...
        .shop-banner {
            ...
            width: 100%;
            height: 220px;
            background: url('https://cdn.pixabay.com/photo/2016/11/22/21/57/apparel-1850804_1280.jpg') center/cover no-repeat;
            border-radius: 0px;
            display: flex;
            align-items: center;
    ...
    <div class="shop-banner">
        <div class="banner-content">
            ...
            <p>Explore trendy handbags, shoulder & tote bags made for every occasion.</p>
            <a href="#products-grid" class="btn btn-light btn-sm">Shop Now</a>
        </div>
    </div>
                            ...
                            <div class="card-body text-center d-flex flex-column">
                                ...
                                <div class="mb-2">
                                    @if ($hasSale)
                                        ...
                                        <span class="fw-bold ms-1" style="color: #b56576">
                                            ${{ $product->sale_price }}
                                        </span>
                                    @else
