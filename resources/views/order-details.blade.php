                    ...
                    <div class="wg-box mt-5 mb-5">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-transaction">
                                ...
                                <tr>
                                    <th>Order Date</th>
                                    <td>{{ $transaction->order->created_at->format('d M, Y h:i A') }}</td>
                                    <th>Delivered Date</th>
                                    <td>{{ $transaction->order->delivered_date ? \Carbon\Carbon::parse($transaction->order->delivered_date)->format('d M, Y') : '-' }}
                                    </td>
                                    <th>Canceled Date</th>
                                    <td>{{ $transaction->order->canceled_date ? \Carbon\Carbon::parse($transaction->order->canceled_date)->format('d M, Y') : '-' }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>Order Status</th>
                    ...
                    <div class="wg-box mt-5">
                        ...
                        <div class="my-account__address-item col-md-6">
                            <div class="my-account__address-item__detail">
                                ...
                                <br />
                                <p><strong>Mobile:</strong> {{ $transaction->order->phone }}</p>
                            </div>
                        </div>
                    </div>
